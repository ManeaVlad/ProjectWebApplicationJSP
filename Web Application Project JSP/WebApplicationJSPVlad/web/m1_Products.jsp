...
<html>
    ...
    <body onload="startTime()">
        <%
            ...
            ResultSet rs = jb.intoarceLinieDupaId("Products", "idProducts", aux);
            rs.first();
        ...
        <nav>
            ...
            <h2 class="title">Change Product</h2>
            <form action="m2_Products.jsp" method="post">
            <label>IdProduct:</label>
                <input type="text" name="idProducts" placeholder="" value="<%= aux%>" readonly>
            <label>Name:</label>
                <input type="text" name="Name" placeholder="Place the name.." value="<%= Name%>">
            <label>Code:</label>
                <input type="text" name="Code" placeholder="" value="<%= Code%>">
            <label>Date:</label>
