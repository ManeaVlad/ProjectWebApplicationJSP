    ...
    <body onload="startTime()">
        ...
        <nav>
            ...
            <tr class="header">
                ...
                <%
                    jb.connect();
                    ResultSet rs = jb.vedeTabela("Components");
                    long x;
                    while (rs.next()) {
                        x = rs.getInt("idComponents");
                %>
                <tr>
                    ...
                    <td><%= rs.getInt("Costs")%></td>
                    <td><%= rs.getString("Parameters")%></td>
                    <%
                        }
                    %>
                </tr>
