...
<html>
    ...
    <body onload="startTime()">
        ...
        <nav>
            ...
            <%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idProducts"));
            String Name = request.getParameter("Name");
            String Code = request.getParameter("Code");
            String Date = request.getParameter("Date");
            String PriceS = request.getParameter("Price");

            String[] valori = {Name, Code, Date, PriceS};
            String[] campuri = {"Name", "Code", "Date", "Price"};
            jb.modificaTabela("Products", "idProducts", aux, campuri, valori);
            jb.disconnect();
        %>
            <br><br><br><br><br>
