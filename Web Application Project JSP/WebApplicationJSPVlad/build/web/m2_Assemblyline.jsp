...
<html>
    ...
    <body onload="startTime()">
        ...
        <nav>
            ...
            <%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idAssemblyline"));
            String idProducts = request.getParameter("idProducts");
            String idComponents = request.getParameter("idComponents");
            String Validation = request.getParameter("Validation");

            String[] valori = {idProducts, idComponents, Validation};
            String[] campuri = {"idProducts", "idComponents", "Validation"};
            jb.modificaTabela("Assemblyline", "idAssemblyline", aux, campuri, valori);
            jb.disconnect();
        %>
            <br><br><br><br><br>
